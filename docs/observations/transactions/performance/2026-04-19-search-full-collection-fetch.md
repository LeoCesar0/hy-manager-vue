...
- **Mesmo padrao (fetch-all)**: [Dashboard carrega tudo](../../dashboard/performance/2026-04-19-dashboard-loads-all-transactions.md) — mesmo anti-pattern de buscar tudo sem limite
